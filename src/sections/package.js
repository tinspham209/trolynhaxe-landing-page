...
const packages = [
  {
    name: "Đăng ký chạy thử",
    description: "Trải nghiệm với những chức năng cơ bản",
    buttonText: "Đăng ký ngay",
    points: [
      {
        icon: <IoIosCheckmarkCircle />,
        text: "Miễn phí mở tài khoản quản lý",
        isAvailable: true,
      },
      {
        icon: <IoIosCheckmarkCircle />,
        text: "Truy cập không giới hạn mọi chức năng đa nền tảng",
        isAvailable: true,
      },
      {
        icon: <IoIosCheckmarkCircle />,
        text: "Đăng nhập phương tiện thông minh với thẻ từ",
        isAvailable: true,
      },
      {
        icon: <IoIosCheckmarkCircle />,
        text: "Hỗ trợ kỹ thuật không giới hạn",
        isAvailable: true,
      },
      {
        icon: <IoIosCloseCircle />,
        text: "Số lượng xe không giới hạn",
        isAvailable: false,
      },
      {
        icon: <IoIosCloseCircle />,
        text: "Hệ thông quản lý lái xe an toàn",
        isAvailable: false,
      },
    ],
  },
...
export default function Package() {
  return (
    <section id="pricing" sx={styles.pricing}>
      <Container>
        <SectionHeader
          title="BẢNG GIÁ CHO DOANH NGHIỆP"
          slogan="Đăng ký sử dụng"
          isWhite={true}
        />
        <Flex
          sx={{
